...
public class ProducerHome : UIModule<ProducerHome>, IActivity {
	Text notificationsLegend;
	public bool isActivityReady
	{
		get
		{
			if (UIModuleCurrentStatus == UIModule<ProducerHome>.UIModuleStatusModes.STAND_BY)
				return true;
			else
				return false;
		}
	...
	protected override string DisplayObjectPath
	{
		get
		{
			return DataPaths.ACTIVITY_PRODUCERHOME_LAYOUT_PATH;
		}
	}
	...
	{
		Debug.Log("ProducerHomeActivity => Terminated");
	}
