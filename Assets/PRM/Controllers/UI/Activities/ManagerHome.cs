...
public class ManagerHome : UIModule<ManagerHome>, IActivity {
	Text notificationsLegend;
	public bool isActivityReady
	{
		get
		{
			if (UIModuleCurrentStatus == UIModule<ManagerHome>.UIModuleStatusModes.STAND_BY)
				return true;
			else
				return false;
		}
	...
	protected override string DisplayObjectPath
	{
		get
		{
			return DataPaths.ACTIVITY_MANAGERHOME_LAYOUT_PATH;
		}
	}
	...
	protected override void ProcessInitialization()
	{
		...
		reportButton.onClick.AddListener (delegate {			
			SessionManager.Instance.OpenActivity(Report.Instance);
			Terminate();
		});
	...
	{
		Debug.Log("ManagerHomeActivity => Terminated");
	}
